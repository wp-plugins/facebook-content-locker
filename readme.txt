...
Lock your content of any page/post in your website, and makes it visible only if the user clicks the Facebook Like button.
...
1. Upload the directory `facebook-content-locker` to the `/wp-content/plugins/` directory
